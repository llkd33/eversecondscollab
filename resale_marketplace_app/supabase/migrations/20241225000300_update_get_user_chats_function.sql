-- Update get_user_chats function to work with the correct chats table structure
-- This fixes the function to use the actual chats table instead of referencing a non-existent table
