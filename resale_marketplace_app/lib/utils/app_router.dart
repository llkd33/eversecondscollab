    ...
    return GoRouter(
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return PhoneAuthScreen(isSignup: isSignup);
        },
      ),
      ...
      ShellRoute(
        ...
        routes: [
          GoRoute(
            path: '/',
            name: 'home',
            builder: (context, state) => const HomeScreenOptimized(), // Using optimized version
          ),
          GoRoute(
            path: '/chat',
            name: 'chat',
        ...
        builder: (context, state) {
          ...
          if (extra == null || extra['product'] == null) {
            return const Scaffold(
              body: Center(child: Text('상품 정보가 필요합니다')),
            );
          }
          return AuthGuard(
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          if (extra == null || extra['transaction'] == null) {
            return const Scaffold(
              body: Center(child: Text('거래 정보가 필요합니다')),
            );
          }
...
class _MainNavigationScreenState extends State<MainNavigationScreen> {
  ...
  Widget build(BuildContext context) {
    final location = GoRouterState.of(context).uri.path;
    final showBottomNav = location == '/' || location == '/chat' || location == '/shop' || location == '/profile';
    return Scaffold(
      body: widget.child,
